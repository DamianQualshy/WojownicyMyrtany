...
if (isset($_GET['poradnik']))
{
    ...
    mysqli_query($GLOBALS['db'], 'UPDATE `konta` SET `poradnik`=1 WHERE `id`='.$user -> get['id']);
	mysqli_query($GLOBALS['db'], "INSERT INTO `ekwipunek` (`stan`, `owner`, `id_broni`) VALUES (0,".$user -> get['id'].",1)");
...
<div class="post">
    <div class="postheader"><h1>Poradnik</h1></div>
	<div class="postcontent">
		...
		<p align="right">Aby zamnkąć kliknij przycisk <input type="submit" class="gothbutton" name="poradnik" value="Dalej"></p>
		</form>
