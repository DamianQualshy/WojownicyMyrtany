...
if (isset($_GET['loguj']))
{
	if (isset($_POST['loguj']))
	{
		...
		$check = mysqli_fetch_array(mysqli_query($GLOBALS['db'], "SELECT login, haslo, tuti FROM konta WHERE login = '".$login."';"));
	   ...
	   else error_div('<span style="color:red;">Wpisano złe dane!</span>');
	}
}
?>
